      ...
      <nav class="bg-gray-800">
            ...
            <div class="hidden md:block">
              <div class="ml-4 flex items-center md:ml-6">
                ...
                <div class="ml-3 relative">
                  ...
                  <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-1 hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
        ...
        <div class="hidden md:hidden">
          <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <a href="#" class="bg-gray-900 text-white px-3 py-2 rounded-md text-base font-medium">Dashboard</a>
